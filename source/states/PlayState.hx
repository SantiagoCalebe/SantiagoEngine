...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['You are bad in this game..', 0.2], //From 0% to 19%
		['Shit', 0.4], //From 20% to 39%
		['Man..', 0.5], //From 40% to 49%
		['Kinda good but still shit', 0.6], //From 50% to 59%
		['Gettin\' into it', 0.69], //From 60% to 68%
		['Noice', 0.7], //69%
		['That\'s good!', 0.8], //From 70% to 79%
		['Great work!!', 0.9], //From 80% to 89%
		['Awesome!!', 1], //From 90% to 99%
		['100% BABY!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	{
		FlxG.stage.window.title = 'Friday Night Funkin\': Santiago\'s Engine - ${SONG.song}';
	...
	public dynamic function updateScore(miss:Bool = false)
	{
		...
		var tempScore:String = 'Score Points: ${songScore}'
	...
	override function destroy() {
		FlxG.stage.window.title = 'Friday Night Funkin\': Santiago\'s Engine';
		#if LUA_ALLOWED
		for (lua in luaArray)
		{
			lua.call('onDestroy', []);
